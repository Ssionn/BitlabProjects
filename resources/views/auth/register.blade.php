    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <a href="https://bitlab.bit-academy.nl/-/profile/personal_access_tokens" target="_blank"
               class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">Get
                your access token</a>
        </div>
