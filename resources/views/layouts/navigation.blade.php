    ...
    <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-800">
            <ul class="space-y-2 font-medium">
                {{-- welcome the user --}}
                <li class="text-xl text-gray-400">
                    <span class="text-gray-400">Welcome,</span>
                    <span class="text-white">{{ ucfirst(auth()->user()->name) }}</span>
                </li>
                <li>
                    <x-nav-link-active :href="route('welcome')" :active="request()->routeIs('welcome')">
                ...
                <li>
                    <x-nav-link-active :href="route('dashboard')" :active="request()->routeIs('dashboard')">
