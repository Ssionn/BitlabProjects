...
<body class="font-sans antialiased">
    ...
    {{-- Temporary Alert --}}
      <div class="flex p-2 text-sm text-yellow-800 bg-yellow-50 dark:bg-gray-800 dark:text-yellow-400" id="fix-alert" role="alert">
          <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
          </svg>
          <span class="sr-only">Danger</span>
          <div>
              <span class="font-medium">The Following is being fixed:</span>
              <ul class="mt-1.5 ml-4 list-disc list-inside">
                  <li>Projects are not loading in currently.</li>
                  <li>Recent activity needs a perfomance fix</li>
