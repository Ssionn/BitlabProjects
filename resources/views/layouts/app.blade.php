...
<head>
    ...
    {{-- <script>
        ...
        var pusher = new Pusher('02ba397ad1e2da80ae22', {
            cluster: 'eu'
        });

        var channel = pusher.subscribe('new-issue-channel');
        channel.bind('new-issue-event', function(data) {
            toastr.success(JSON.stringify(data) + ' has been created');
        });
